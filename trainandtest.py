# -*- coding: utf-8 -*-
"""
Created on Fri Jun 23 11:06:35 2017
...
if __name__ == '__main__':
    sample = open("C:/Users/hpant/Documents/Documents/NLP/v1/review.txt")
...
FILE = ("C:/Users/hpant/Documents/Documents/NLP/v1/test11.txt")
FILE_WRITE = open("C:/Users/hpant/Documents/Documents/NLP/v1/test.txt", "w")
for line in FILE:
 	classifier = Naive_Bayes_Classifier(positive, negative, total_negative, total_positive, line)
if classifier == 0:
	FILE.write(line + 'Negative')
else:
    FILE.write(line + 'Positive')

os.rename(FILE, FILE_WRITE)     
